    ...
    <div className="relative h-[calc(100vh-80px)] overflow-hidden px-8">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 z-10 
                        rounded-t-full bg-[#6ab0b5] w-[40%] aspect-[4/3]">
        </div>

        {/* Hero title */}
        <p className="xl:text-[22rem] lg:text-[15rem] delirium font-medium tracking-[1.5rem] text-center z-20 mt-[-10%] relative">
          KELVIN DUCHE
        </p>

        {/* Tagline */}
        <div className="absolute top-32 right-[15%] border border-white rounded-full px-4 py-2 text-sm z-50 cursor-pointer">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 z-30 w-1/2">
          <Image
            ...
            height={800}
            alt="Kelvin Duche"
            className="w-[80%] h-auto mx-auto relative"
          />
        </div>
        ...
        <Image
          ...
          className="absolute top-[20%] left-[15%] z-40 rotate-[-15deg] shake-on-hover cursor-pointer spin-animation"
          width={100}
          height={60}
          alt="Figma"
        />
        <Image
          ...
          className="absolute top-[30%] right-[30%] z-40 rotate-[15deg] shake-on-hover cursor-pointer spin-animation"
          width={100}
          height={60}
          alt="Photoshop"
        />
        <Image
          ...
          className="absolute bottom-[50%] left-[35%] z-40 rotate-[15deg] shake-on-hover cursor-pointer spin-animation"
          width={100}
          height={60}
          alt="Illustrator"
        />
        ...
        {/* Skill tags */}
        <div className="absolute bottom-0 left-[10%] grid gap-2 z-0 py-6">
